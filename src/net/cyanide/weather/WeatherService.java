...
public class WeatherService extends Service {
    ...
    private static final String ACTION_UPDATE = "net.cyanide.weather.ACTION_UPDATE";
    private static final String ACTION_ALARM = "net.cyanide.weather.ACTION_ALARM";

    private static final String EXTRA_FORCE = "force";

    static final String ACTION_CANCEL_LOCATION_UPDATE =
            "net.cyanide.weather.CANCEL_LOCATION_UPDATE";
